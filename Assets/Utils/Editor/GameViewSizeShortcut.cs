...
namespace Wappen.Editor
{
    ...
    {
        [Shortcut( "Wappen/Switch Game view to 720p", KeyCode.J, ShortcutModifiers.Alt )]
        static void _To720( )
        {
        ...
        [Shortcut( "Wappen/Switch Game view to 1080p", KeyCode.K, ShortcutModifiers.Alt )]
        static void _To1080( )
        {
            switch( GameViewUtils.GetCurrentGroupType( ) )
            {
        ...
        [Shortcut( "Wappen/Switch Game view to 1440p", KeyCode.L, ShortcutModifiers.Alt )]
        static void _To1440( )
        {
            switch( GameViewUtils.GetCurrentGroupType( ) )
            {
