...
public static class GameViewUtils
{
    ...
    {
        AddCustomSize(GameViewSizeType.AspectRatio, GameViewSizeGroupType.Standalone, 1120, 850, "TestSize_");
    }
    //ЧИ ІСНУЄ Такий LAbel
    ...
    private static bool SizeExists(GameViewSizeGroupType sizeGroupType, string text)
    {
